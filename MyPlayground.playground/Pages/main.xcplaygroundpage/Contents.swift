...
*/
var bankAccountBalance = 6000000000
...
*/
// I can't do this without changing the declaration of the string because "let" is not mutable, while "var" IS mutable.
// If it were valid to do so, I would write:
// puppyName = "Ciao-Ciao"
puppyName = "Ciao-Ciao"
